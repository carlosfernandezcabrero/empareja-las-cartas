  ...
  return (
    <CleanLayout>
      <DialogContainer>
        ...
        {isLoading ? (
          <div role="status" className="text-center grid gap-6">
            <svg
              aria-hidden="true"
              className="w-14 h-14 text-gray-200 animate-spin fill-sky-700 mx-auto"
              viewBox="0 0 100 101"
              fill="none"
            ...
            <span className="font-bold text-base animate-pulse">
              Comprobando si ya iniciaste sesión ...
            </span>
          </div>
        ) : (
